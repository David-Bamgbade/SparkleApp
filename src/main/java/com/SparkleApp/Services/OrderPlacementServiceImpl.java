...
public class OrderPlacementServiceImpl implements OrderPlacementService {
    ...
    public CreateOrderResponse createOrder(CreateOrderRequest createOrderRequest) {
        ...
        OrderPlacement order = (OrderPlacement) placementRepository.save(orderPlacement);
    ...
    @Override
    public UpdateOrderResponse updateOrder(Long orderId, UpdateOrderRequest updateOrderRequest) throws Throwable {
    ...
    private  OrderPlacement findById(Long orderId) throws Throwable {
        return (OrderPlacement) placementRepository.findById(orderId).orElseThrow(() -> new RuntimeException("Order not found"));
    }
